...
export default function(state=null,action) {
    const image =  {
      Jadoo : 'https://images.vexels.com/media/users/3/132066/isolated/preview/71646d7673e8847ab07b3b7e78928777-search-circle-icon-by-vexels.png',
    ...
    return[
        {id:'0',name:'Jadoo',image: image.Jadoo},
